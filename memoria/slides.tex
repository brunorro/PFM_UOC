...
\frame{
	...
	\begin{figure}[!hbt]
		\centering
		\includegraphics[width=6cm]{imagenes/PrototipoReconocimiento.png}
...
\frame{
	...
	\begin{slide}
		Tras el cálculo de la eficiencia para las variantes aplicadas, se llegó a la conclusión que la mejor opción era el uso de la distancia euclídea con filtrados superpuestos:\\
	\footnotesize{
...
\frame{
	\frametitle{Tiempos}
	\begin{slide}
	Tiempos desde que se obtiene la imagen hasta que se tiene la face signature según los procedimientos indicados en el ordenador en el que se ha desarrollado la aplicación:
	\begin{center}
